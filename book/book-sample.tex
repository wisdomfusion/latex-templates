%!TEX program = xelatex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% progbook - LaTeX template for programming language
%% and other technical contents
...
\newcommand{\framedinfo}[1]{
  \vspace{2ex}
  \begin{tcolorbox}[width=\textwidth, boxsep=10pt, left=0pt, right=0pt, top=2pt, arc=3pt, boxrule=1pt, colback=white]
...
\framedinfo{JavaScript 中，每个文件是一个模块，文件中定义的所有对象都从属于那个模块。 通过 export 关键字，模块可以把它的某些对象声明为公共的。 其它 JavaScript 模块可以使用import 语句来访问这些公共对象。}
